...
def HII_CHIm_UV(inputfile,outputfile):
   """
   This is HII-CHI-mistry v. 3.0 for UV modified to be easier to use for a lot of objects.
   Parameters:
   -----------
   inter: int
   ...
   np.savetxt(outputfile+'.dat',out,fmt='%.4f',delimiter='\t',
      header='Lya1216\t[CIV1549\tOIII]1665\tCIII1909\tHb4861\t[OIII] 5007\tgrid\t12+log(O/H)\tlog(N/O)\tlog U')
         
   return (round(OHff,3), round(eOHff,3),round(COff,3), round(eCOff,3),round(logUff,3), round(elogUff,3))
